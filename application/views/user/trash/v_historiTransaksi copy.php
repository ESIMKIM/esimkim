                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <br>
                                            <div class="card text-white rounded-3" style="height: 500px; line-height: 30px; border-radius: 20px; color: black;">
                                                <div class="card-body" style="color: black;">
                                                    <h4 class="mb-2" style="text-align: center;">Filter
                                                    </h4>
                                                    <hr>
                                                    <form class="mt-4">
                                                        <p class="mb-2">Masukan Nomor Surat :</p>
                                                        <div class="form-outline form-white mb-4">
                                                            <input type="text" id="nosurat" class="form-control form-control-lg" size="17" placeholder="Nomor Surat" />
                                                            <!-- <label class="form-label" for="typeName">Nomor Surat</label> -->
                                                        </div>
                                                        <hr>
                                                        <p class="mb-2">Berdasarkan Tanggal </p>
                                                    ...
                                                    <button type="button" onclick="submit_cart()" class="btn btn-info btn-block btn-lg" style="border-radius: 15px;">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-2">
                                                            <img src="<?= base_url('assets/img/users/icons1.png') ?>" class="img-fluid rounded-3" alt="Shopping item" style="width: 80px;">
                                                        </div>
                                                        <div class="col-lg-7">
                                                            </br>
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <a href="<?php $data = 1;
                                                                        echo base_url('detail-transaction/') . $data; ?>" id="btn_hapus_cart" class="btn btn-primary">Detail
                                                                Transaksi</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <a href="#" id="btn_hapus_cart" onclick="hapus_item_onCart(1)" class="btn btn-primary">Detail Transaksi</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
