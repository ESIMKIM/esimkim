        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col text-center">
                    <a href="<?php echo base_url('transactions-user') ?>" class="btn btn-primary"><span style="color:black">Selesaikan</span></a>
                </div>
...
<div class="col-xl-12 col-lg-12 col-md-12">
    <!-- Start Filter Bar -->
    <div class="filter-bar d-flex flex-wrap align-items-center" style="background-color: #ccc;">
        ...
        <nav aria-label="Page navigation example">
            <div class="text-xs-center" style="margin-right: 5%;">
                <?php echo $pagination; ?>
            </div>
        </nav>
    </div>
    ...
    <section class="lattest-product-area pb-40 category-list">
        <div class="row">
            ...
            foreach ($result as $data) : ?>
                ...
                $varName = '';
                if ($data['qty'] >= 1) {
                    $varName = '<span style="color:green;">Tersedia<span>';
                    $color = "btn-info";
                } else {
                    $varName = '<span style="color:red;">Habis<span>';
                    $color = "btn-warning";
                }
                ...
                <div class="col-4">
                    <div class="single-product">
                        <table>
                            <tr>
                                <th><img class="img-fluid" src="<?= $data['images']; ?>" style="width: 100px;
								height: 80px;
                            ...
                            <tr>
                                <td style="height: 70px; vertical-align:top ;">
                                    <div class="product-details">
                                        ...
                                        <?php if ($length <= 21) : ?>
                                            <h6 style="font-size: 10pt;"><?= $content ?></h6>
                                            <br>
                                        <?php else : ?>
                                            <h6 style="font-size: 10pt;"><?= $content ?></h6>
                                        <?php endif; ?>
                        ...
                        <!-- <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <img class="img-fluid" src="<?= $data['images']; ?>" style="width: 100px;
								height: 80px;
								object-fit: fill;" alt="">
                                <div class="product-details">
                                    <input id="prod_id_<?php echo $i ?>" name="prod_id" value="<?= $data['products_id']; ?>" hidden>
                                    <?php if ($length <= 21) : ?>
                                        <h6 style="font-size: 8pt;"><?= $content ?></h6>
                                        <br>
                                    <?php else : ?>
                                        <h6 style="font-size: 8pt;"><?= $content ?></h6>
                                    <?php endif; ?>
                                    ...
                                    <div class="price">
                                        <h6 style="font-size: 8pt;"><?= $varName ?></h6>
                                    </div>
                                </div>
                            </div>
                            <br>
...
<!-- start footer Area -->
<?php $this->load->view('user/template/4_mfooter'); ?>
<!-- End footer Area -->
...
<script src="<?php echo base_url('assets/js/mainBottom.js') ?>"></script>
<!--gmaps Js-->
...
<script type="text/javascript">
    ...
    function cek() {
        var data = <?php echo $ttd_belum[0]->status; ?>;
        console.log(data);
        if (data !== null) {
