...
============================================================================================ */
    .banner-area {
        background: url(<?php echo base_url('assets/img/banner/sasa.jpg') ?>) center no-repeat;
    ...
    .organic-breadcrumb {
        background: url(<?php echo base_url('assets/img/banner/xc.jpg') ?>) center no-repeat;
        background-size: cover;
        padding-top: 130px;
    }
