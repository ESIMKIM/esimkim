...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/stylesBottom.css" />
...
============================================================================================ */
        ...
        @media (max-width: 767px) {
            .organic-breadcrumb {
                background: url(<?php echo base_url('assets/img/banner/stationary-bannerM.jpg') ?>) center no-repeat;
                background-size: cover;
                object-fit: fill;
                width: 100%;
                height: 40%;
...
<body id="category" style="margin-left: -3%; margin-right: 0%;">