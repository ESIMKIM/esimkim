        ...
        <div class="row">
            <div class="col-lg-12 col-md-6 col-sm-12">
                <div class="card" style="padding: 20px;">
                    ...
                    <div class="card-header">
                        ...
                        <p>Kode Permohonan : <?php echo $data[0]->no_invc?> </p>
                        <p>Tanggal : <?php echo $data[0]->tgl_surat?></p>
                        <!-- <p>Status : Selesai</p> -->
                    </div>
                        ...
                        <table id="mydata" class="table">
                            ...
                            <tbody id="show_data">
                                <tr>
                                    ...
                                    <td style="text-align:center;"><textarea name="alasanAdmin"></textarea>
                                    </td>
                                </tr>
                                <tr>
            ...
            <!-- <div class=" col-lg-5 col-md-6 col-sm-12">
                <div class="card" style="padding: 50px;">
                    <h5 class="card-header">Stock Saat ini</h5>
                    <div class="table-responsive text-nowrap">
                        <table id="mydata" class="table">
                            <thead>
                                <tr class="text-nowrap" style="text-align:center;">
                            ...
                            <tbody id="show_data">
                                <tr style="text-align:Left;">
                                    <td>SPIDOL BESAR HITAM PERMANEN
                                    </td>
