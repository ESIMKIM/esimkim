...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"></span> Barang
        </h4>
                        ...
                        <table id="mydata" class="table">
                            ...
                            <tbody id="show_data">
                                <tr style="text-align:center;">
                                    ...
                                    <td>SPIDOL HITAM WHITEBOARD </td>
                                    <td>Alat Tulis</td>
                                    <td>150</td>
                                    <td style="text-align:center;">
                                        <!-- <a title="Cetak BAST" href="#javascript:;" class="tambahBarang" data-bs-toggle="modal" data-bs-target="#mInputPerangkat"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:print" width="40" height="40"></iconify-icon>
                                            </i></a> -->
                                        <a title="Edit" href="<?php echo base_url('proses_transaksi') ?>">
                                            <i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:edit-alt" width="40" height="40"
                                                    style="color: orange;">
                                                </iconify-icon>
                                            </i> </a>


                                        <a title="Non Aktif" href="#javascript:;" class="tambahBarang"
                                            data-bs-toggle="modal" data-bs-target="#mInputPerangkat"><i
                                                class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:check-square" width="40" height="40"
                                                    style="color: blue;">
                                                </iconify-icon>
                                            </i></a>
                                    </td>
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:center;">
                                        ...
                                        <!-- <a title="Lihat BAST" href="#javascript:;" class="liatNodin"><i
                                                class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="bxs:file-pdf" width="40" height="40"></iconify-icon> -->
                                        </i></a>
                                        <a title="Aktifkan" href="#javascript:;" class="tambahBarang"
                                            data-bs-toggle="modal" data-bs-target="#mInputPerangkat"><i
                                                class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:check-square" width="40" height="40"
                                                    style="color: red;">
