...
<div class="content-wrapper">
    ...
    <!-- edit Perangkat Modal -->
    <div class="modal fade" id="mEditPerangkat" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <table id="mydata" class="table">
                            <thead>
                                <tr class="text-nowrap" style="text-align:center;">
                                    ...
                                    <th style="text-align:center;">Harga PerItem</th>
                            ...
                            <tbody id="show_data">
                                <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:center;">
                                        <a title="Tambah" data-bs-toggle="modal" data-bs-target="#mUpdateStok"
                                        ...
                                        <a title="Edit" data-bs-toggle="modal" data-bs-target="#mEditPerangkat"
                                            href="<?php echo base_url('update-transaksi-masuk') . '/1' ?>"><i
                                                class="menu-icon tf-icons" style="text-align:center; color:grey">
                                        ...
                                        <a title="Histori"
                                            href="<?php echo base_url('master-histori-stok-peritem') . '/1' ?>"><i
                                                class="menu-icon tf-icons" style="text-align:center; color:grey">
                                ...
                                <!-- <tr style="text-align:center;">
                                    ...
                                    <td>5500</td>
                                    <td style="text-align:center;">
                                        <a title="Tambah" data-bs-toggle="modal" data-bs-target="#mUpdateStok" href="<?php echo base_url('update-transaksi-masuk') . '/1' ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="fluent:box-arrow-up-24-regular" width="40" height="40">
                                                </iconify-icon>
                                            </i></a>

                                        <a title="Edit" data-bs-toggle="modal" data-bs-target="#mEditPerangkat" href="<?php echo base_url('update-transaksi-masuk') . '/1' ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="fluent:box-edit-20-regular" width="40" height="40">
                                                </iconify-icon>
                                            </i></a>
                                        <a title="Histori" href="<?php echo base_url('master-histori-stok-peritem') . '/1' ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
