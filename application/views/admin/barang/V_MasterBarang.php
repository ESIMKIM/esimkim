                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-control">
                                    ...
                                    <input hidden type="text" id="prodId" name="prodId"
                                        class="form-control form-control-lg" value='' />
                                    <input type="text" id="no_po" name="no_po" class="form-control form-control-lg"
                                        siez="17" placeholder="Nomor PO" />
                                </div><br>
                                <div class="form-control">
                                    <label class="form-label">Tanggal PO</label>
                                    <input type="date" id="tgl_surat" name="tgl_surat"
                                        class="form-control form-control-lg" siez="17" placeholder="Nomor Surat" />
                                </div></br>
                                <div class="form-control">
                                    <label class="form-label">Harga Per Barang</label>
                                    <input type="number" id="harga" name="harga" class="form-control form-control-lg"
                                        siez="17" placeholder="Harga Barang Per Item" />
                                </div><br>
                                <div class="form-control">
                                    <label class="form-label">Jumlah Barang</label>
                                    <input type="number" id="jumlah" name="jumlah" class="form-control form-control-lg"
                                        siez="17" placeholder="Jumlah Barang" />
                                </div><br>
                                <div class="form-control">
                                ...
                                <div class="form-control">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="thumbnails_invoice"
                                            id="thumbnails_invoice">
                                    </div>
...
$(document).ready(function() {
    $('#mydata').dataTable({
        ...
        dom: '<"bottom"Bf>rt<"top"lip><"clear">',
        layout: {
            topStart: {
                buttons: ['pageLength']
            }
        ...
        pageLength: 10,
        ajax: {
            url: '<?php base_url() ?>/get_barangMaster',
            type: 'POST',
            dateType: 'JSON',
        },
        columns: [{
                "render": function(data, type, JsonResultRow, meta) {
                    return '<img src="' + JsonResultRow.gambar +
                        '" class="img-fluid rounded-3" style="width: 80px;" alt="Shopping item">';
                }
            },
            {
                data: 'nama_barang'
            ...
            },
            {
                "render": function(data, type, JsonResultRow, meta) {
                    ...
                    return '<a title="Tambah Stock" id="tambahStock" class="open-AddBookDialog" data-id="' +
                        JsonResultRow.products_id +
                        '" data-bs-toggle="modal" data-bs-target="#mUpdateStok" href="#"> <i class="menu-icon tf-icons" style="text-align:center; color:grey"></i> <iconify-icon icon="fluent:box-arrow-up-24-regular" width="40" height="40"></iconify-icon> </a> <a title="Edit" href="<?php echo base_url("master-barang-edit/") ?>' +
                        JsonResultRow.products_id +
                        '"> <i class="menu-icon tf-icons" style="text-align:center; color:grey"></i> <iconify-icon icon="fluent:box-edit-20-regular" width="40" height="40"></iconify-icon> </a> <a title="History" href="<?php echo base_url("history-stock/") ?>' +
                        JsonResultRow.products_id +
                        '"> <i class="menu-icon tf-icons" style="text-align:center; color:grey"></i> <iconify-icon icon="fluent:box-search-16-regular" width="40" height="40"></iconify-icon> </a>';
                }
