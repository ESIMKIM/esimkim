...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"></span> Inventory ATK
        </h4>
                        ...
                        <table id="mydata" class="table">
                            <thead>
                                <tr class="text-nowrap">
                                    ...
                                    <th style="text-align:left;">Merk Barang</th>
                                    <th style="text-align:left;">Harga Perbarang</th>
            ...
            },
            {
                "render": function(data, type, JsonResultRow, meta) {
                    return '<a title="Tambah Stock" id="tambahStock" class="open-AddBookDialog" data-id="' +
                        ...
                        '" data-bs-toggle="modal" data-bs-target="#mUpdateStok" href="#"> <i class="menu-icon tf-icons" style="text-align:center; color:grey"></i> <iconify-icon icon="fluent:box-arrow-up-24-regular" width="40" height="40"></iconify-icon> </a>';
                }
