        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card" style="padding: 50px;">
                    <h5 class="card-header">Daftar Master Transaksi</h5>
                    <div class="table-responsive text-nowrap">
                        <table id="mydata2" class="table">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align:center;">
                                    <td><?= $i ?></td>
                                    <td><?= $data->no_surat; ?></td>
                                    <td> <?= $data->alias_dept; ?></td>
                                    <td><?= $data->tgl_surat; ?> </td>
                                    <td style="text-align:center;">
                                        <a title="Proses Permintaan"
                                            href="<?php echo base_url('proses_transaksi_master/') . $data->th_id ?>">
                                        ...
                                        <a title="Lihat BAST" class="liatNodin"><i class="menu-icon tf-icons"
                                                style="text-align:center; color:grey">
                                                <iconify-icon icon="bxs:file-pdf" width="40" height="40"></iconify-icon>
                                            </i></a>
                                        <?php else : ?>
                                        <a title="Lihat Lampiran" href="<?php echo $set_net . $data->url_nodin ?>"
                                        ...
                                        <a title="Cetak Bukti Pengambilan"
                                            href="<?php echo base_url('cetak_BASTK/') . $data->th_id ?>"><i
                                                class="menu-icon tf-icons" style="text-align:center; color:orange;">
                                                <iconify-icon icon="teenyicons:invoice-outline" width="40" height="40">
                                                </iconify-icon>
                                            </i></a>
                                    </td>
                                </tr>
