...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"></span> Master Satuan
        </h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="perangkatBaru">
                            <div class="row">
                                <p>Input Kategori Satuan</p>
                                <hr>
                                <div class="col-12 mb-3">
                                    <br>
                                    <label for="nameExLarge" class="form-label">Satuan Barang</label>
                                    <input type="text" id="satuanBarang" name="satuanBarang" class="form-control" placeholder="Masukan Satuan Barang" />
                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn_simpan').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url() ?>/submits-satuan',
                dataType: "JSON",
                data: data,
                processData: false,
                contentType: false,
