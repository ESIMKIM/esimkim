                        ...
                        <form id="perangkatBaru">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <br>
                                    <label for="nameExLarge" class="form-label">Update Version <span
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <label for="nameExLarge" class="form-label">Keterangan Update <span
                                            style="color: red;">*</span></label>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="image-upload">
                                        <label for="nameExLarge" class="form-label">Video Update <span
                            ...
                            <tbody id="show_data">
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td><video width="200" height="200" controls>
                                            <source src="<?php echo base_url('') . $data->url_video ?>"
                                                type="video/mp4">
...
$(document).ready(function() {
    ...
    $('#btn_simpan').on('click', function() {
        ...
        data.append('cs', $('input[type=file]')[0].files[0]);
