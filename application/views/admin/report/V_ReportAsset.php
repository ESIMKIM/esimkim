        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card" style="padding: 50px;">
                    <div class="row">
                        <div class="col-7">
                            <!-- <h4 class="card-header" style="margin-top: -25px;">Report Stock Item</h4><br> -->
                            <a href="<?php echo base_url('laporan-stokall') ?>" class="btn btn-info">Laporan Stock Total
                                Item</a>
                            <br><br>
                            <a href="<?php echo base_url('laporan-transUser') ?>" class="btn btn-success">Laporan Data
                                Transaksi</a>
                            <br><br>
                            <a href="<?php echo base_url('laporan-itemTrans') ?>" class="btn btn-warning">Cari Transaksi
                                Peritem</a>
                    ...
                    <hr>
                    <h4>Semua Data Barang Kwitansi</h4>
                    <br>
