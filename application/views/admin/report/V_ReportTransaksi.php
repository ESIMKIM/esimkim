            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card" style="padding: 50px;">
                        <div class="row">
                            <div class="col-8">
                                <h4 class="card-header" style="margin-top: -25px;">Pengiriman Barang ke
                                    masing-masing Direktorat / Bagian (Per Bulan)</h4>
                                <br>
                                <form action="<?php echo base_url("cari_laporan_deptId") ?>" method="post">
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            <select class="form-select" id="dept_id" name="dept_id">
                                                ...
                                                <?php foreach ($listBagian as $data) : ?>
                                                    <option value="<?php echo $data->id_department ?>">
                                                        <?php echo $data->alias_dept ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                            <!-- <input type="date" name="dept_id" class="form-select" id="dept_id" /> -->
                                        </div>
                                        <!-- <div class="col-3">
                            ...
                            <div class="col-4">
                                <div class="position-relative">
                                    <img src="<?php echo base_url("assets/img/gif/data3.gif") ?>" alt="Computer man" width="50%" style="margin-left: 100px;">
                                </div>
                            </div>
                        </div>
                        <hr>
