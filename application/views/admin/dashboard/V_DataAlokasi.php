                            ...
                            <tbody id="show_data">
                                <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:center;">
                                        <a title="Lihat" href="<?php echo base_url('data-alokasi-detail') ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="icon-park-outline:view-grid-detail" width="40" height="40">
                                                </iconify-icon>
                                            </i></a>
                                    </td>
                                </tr>
                                <tr style="text-align:center;">
                                    ...
                                    <td>1500</td>
                                    <td style="text-align:center;">
                                        <a title="Lihat" data-bs-toggle="modal" data-bs-target="#mUpdateStok" href="<?php echo base_url('update-transaksi-masuk') . '/1' ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="icon-park-outline:view-grid-detail" width="40" height="40">
                                                </iconify-icon>
                                            </i></a>
                                    </td>
                                ...
                                <tr style="text-align:center;">
                                    <td style="display: none;">id coy</td>
                                    <td>3</td>
                                    <td>Direktorat Izin Tinggal Keimigrasian</td>
                                    <td>1400</td>
                                    <td>1380</td>
                                    <td style="text-align:center;">
                                        <a title="Lihat" data-bs-toggle="modal" data-bs-target="#mUpdateStok" href="<?php echo base_url('update-transaksi-masuk') . '/1' ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                ...
                                <tr style="text-align:center;">
                                    <td style="display: none;">id coy</td>
                                    <td>4</td>
                                    <td>Direktorat Pengawasan dan Penindakan Keimigrasian</td>
                                    <td>1750</td>
                                    <td>1500</td>
                                    <td style="text-align:center;">
                                        <a title="Lihat" data-bs-toggle="modal" data-bs-target="#mUpdateStok" href="<?php echo base_url('update-transaksi-masuk') . '/1' ?>"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
