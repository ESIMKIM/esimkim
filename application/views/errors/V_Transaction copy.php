                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" id="no_surat" name="no_surat" class="form-control" placeholder="Enter No Surat" />
                            </div>
                            </br>
                            <div class="form-control">
                                <label for="nameExLarge" class="form-label">No Surat Nodin</label>
                                <input type="text" id="no_nodin" name="no_nodin" class="form-control" placeholder="Enter No Nodin" />
                            </div>
                            </br>
                            <div class="form-control">
                            ...
                            <div class="form-control">
                                <label for="nameExLarge" class="form-label">Upload Nodin <span style="color: red;"><br>WARNING : <br>1. Jika
...
<!-- Tambah Barang -->
<div class="modal fade" id="mSubmitPerangkat" aria-hidden="true">
    <div class="modal-dialog modal-l" role="document">
        <div class="modal-content">
            <form id="transaksi">
                <div class="modal-header">
                            ...
                            <tbody id="show_data">
                                <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:center;">
                                        <a title="Cetak BAST" href="#javascript:;" class="tambahBarang" data-bs-toggle="modal" data-bs-target="#"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                        ...
                                        <a title="Lihat BAST" href="#javascript:;" class="liatNodin"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="bxs:file-pdf" width="40" height="40"></iconify-icon>
                                            </i></a>
                                        <a title="Submit" href="#javascript:;" class="tambahBarang" data-bs-toggle="modal" data-bs-target="#mSubmitPerangkat"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td>Direktorat Kerja Sama Keimigrasian</td>
                                    <td>13/09/2023</td>
                                    <td style="color: red;">Di Tolak</td>
                                    <td style="text-align:center;">
                                        <a title="Cetak BAST" href="#javascript:;" class="tambahBarang" data-bs-toggle="modal" data-bs-target="#"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:print" width="40" height="40"></iconify-icon>
                                            </i></a>
                                        <a title="Proses Permintaan" href="#javascript:;" class="daftarPerangkat" data-bs-toggle="modal" data-bs-target="#mDaftarPerangkat"> <i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:file-info-alt" width="40" height="40">
                                                </iconify-icon>
                                            </i> </a>
                                        <a title="Lihat BAST" href="#javascript:;" class="liatNodin"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:center;">
                                        <a title="Cetak BAST" href="#javascript:;" class="#" data-bs-toggle="modal" data-bs-target="#"><i class="menu-icon tf-icons" style="text-align:center; color:grey">
                                                <iconify-icon icon="uil:print" width="40" height="40"></iconify-icon>
                                            </i></a>
                                        <a title="Proses Permintaan" href="<?php echo base_url('proses_transaksi') ?>">
                                            <i class="menu-icon tf-icons" style="text-align:center; color:grey">
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr style="text-align:center;">' +
                            ...
                            '<td>' + data[i].name + '</td>' +
                            '<td style="text-align:center;">' +
                            '<a title="Cetak BAST" href="#javascript:;" class="tambahBarang" data-bs-toggle="modal" data-bs-target="#" data="' +
                            data[i].th_id +
                            ...
                            ' ' +
                            '<a title="Tambah Perangkat" href="#javascript:;" class="tambahBarang" data-bs-toggle="modal" data-bs-target="#mSubmitPerangkat" data="' +
                            data[i].th_id +
